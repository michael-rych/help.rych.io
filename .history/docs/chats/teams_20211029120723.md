...
+ If the chat occured today then only time will be displayed else. If the chat took place yesterday then the word **yesterday** will be shown else it will be the date in terms of 
