...
+ Please note current active chat window means current chat which is in reply mode, chat who can type and send reply to.

> marker 9 and marker 3 will have the same value.
