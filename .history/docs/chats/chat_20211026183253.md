...
> a selected list is known by the list name appearing bold. In this example the list Unassigned is active as the name appears in bold relative to two other list 
