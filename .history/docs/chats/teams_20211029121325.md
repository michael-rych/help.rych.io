...
+ Please note current active chat window means current chat which is in reply mode chat who can type and send reply to it is the same as marker number 3.
